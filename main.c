    ...
    while(leave == 0) {
        ...
        switch (operation) {
            case 1:
                ...
                break;
            case 2:
                printf("Qual item você gostaria de adicionar?\n");
                list_items(item, quant);
                scanf("%d", &selected_item);
                printf("Quantos itens você quer adicionar?\n");
                scanf("%d", &selected_quantity);
                quantity[selected_item - 1] += selected_quantity;
                save_file(item, quantity, quant);
                break;
            case 3:
                printf("Qual item você gostaria de remover?\n");
                list_items(item, quant);
                scanf("%d", &selected_item);
                printf("Quantos itens você quer remover?\n");
                scanf("%d", &selected_quantity);
                quantity[selected_item - 1] -= selected_quantity;
                save_file(item, quantity, quant);
                break;
